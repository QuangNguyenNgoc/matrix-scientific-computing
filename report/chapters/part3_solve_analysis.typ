...
Nhóm lưu toàn bộ kết quả benchmark dưới dạng `.csv`, sau đó sử dụng notebook phân tích để dựng bảng tổng hợp và biểu đồ trực quan. Các bảng số liệu đầy đủ được đưa vào phụ lục, xem @tbl:runtime-full, @tbl:hilbert-full và @tbl:spd-full.
